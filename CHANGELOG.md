...
- **Permission cache hardening — review follow-ups on PR #1665** (`opencontractserver/utils/{permissioning,permission_optimizer}.py`, `opencontractserver/shared/user_can_mixin.py`, `opencontractserver/constants/permissioning.py`, `opencontractserver/tests/permissioning/test_permission_optimizer.py`).
