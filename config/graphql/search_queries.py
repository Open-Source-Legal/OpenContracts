...
from config.graphql.annotation_types import AnnotationType, NoteType
...
@login_required
def _resolve_Query_semantic_search(root,
    info,
    query,
    corpus_id=None,
    document_id=None,
...
@login_required
def _resolve_Query_semantic_search_relationships(root,
    info,
    query,
    corpus_id=None,
    document_id=None,
