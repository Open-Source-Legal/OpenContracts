...
from config.graphql import authority_namespace_mutations as _authority_namespace_mutations
...
from config.graphql import document_relationship_mutations as _document_relationship_mutations
