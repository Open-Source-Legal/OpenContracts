...
class AnalyzerType(Node):
    ...
    manifest: Optional[GenericScalar] = strawberry.field(name="manifest", default=None)
    ...
    host_gremlin: Optional["GremlinEngineType_WRITE"] = strawberry.field(name="hostGremlin", default=None)
    ...
    input_schema: Optional[GenericScalar] = strawberry.field(name="inputSchema", description="JSONSchema describing the analyzer's expected input if provided.", default=None)
    ...
    def full_label_list(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["AnnotationLabelType", strawberry.lazy("config.graphql.annotation_types")]]]]:
        kwargs = strip_unset({})
...
class GremlinEngineType_WRITE(Node):
    ...
    last_synced: Optional[datetime.datetime] = strawberry.field(name="lastSynced", default=None)
    install_started: Optional[datetime.datetime] = strawberry.field(name="installStarted", default=None)
    install_completed: Optional[datetime.datetime] = strawberry.field(name="installCompleted", default=None)
    is_public: bool = strawberry.field(name="isPublic", default=None)
...
class ExtractType(Node):
    ...
    corpus_action: Optional[Annotated["CorpusActionType", strawberry.lazy("config.graphql.agent_types")]] = strawberry.field(name="corpusAction", default=None)
    parent_extract: Optional["ExtractType"] = strawberry.field(name="parentExtract", description='Extract this iteration was forked from. Null for the root of an iteration series.', default=None)
    model_config: Optional[GenericScalar] = strawberry.field(name="modelConfig", description='Captured model/run configuration for this iteration.', default=None)
    ...
    def full_document_list(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["DocumentType", strawberry.lazy("config.graphql.document_types")]]]]:
        kwargs = strip_unset({})
...
class FieldsetType(Node):
    ...
    def description(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "description", None))
    corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql.corpus_types")]] = strawberry.field(name="corpus", description='If set, this fieldset defines the metadata schema for the corpus', default=None)
    @strawberry.field(name="corpusactionSet")
    def corpusaction_set(self, info: strawberry.Info, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET, id: Annotated[Optional[strawberry.ID], strawberry.argument(name="id")] = strawberry.UNSET, name: Annotated[Optional[str], strawberry.argument(name="name")] = strawberry.UNSET, name__icontains: Annotated[Optional[str], strawberry.argument(name="name_Icontains")] = strawberry.UNSET, name__istartswith: Annotated[Optional[str], strawberry.argument(name="name_Istartswith")] = strawberry.UNSET, corpus__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="corpus_Id")] = strawberry.UNSET, fieldset__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="fieldset_Id")] = strawberry.UNSET, analyzer__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="analyzer_Id")] = strawberry.UNSET, agent_config__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="agentConfig_Id")] = strawberry.UNSET, trigger: Annotated[Optional[enums.CorpusesCorpusActionTriggerChoices], strawberry.argument(name="trigger")] = strawberry.UNSET, creator__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="creator_Id")] = strawberry.UNSET, source_template__id: Annotated[Optional[strawberry.ID], strawberry.argument(name="sourceTemplate_Id")] = strawberry.UNSET) -> Annotated["CorpusActionTypeConnection", strawberry.lazy("config.graphql.agent_types")]:
        kwargs = strip_unset({"offset": offset, "before": before, "after": after, "first": first, "last": last, "id": id, "name": name, "name__icontains": name__icontains, "name__istartswith": name__istartswith, "corpus__id": corpus__id, "fieldset__id": fieldset__id, "analyzer__id": analyzer__id, "agent_config__id": agent_config__id, "trigger": trigger, "creator__id": creator__id, "source_template__id": source_template__id})
        resolved = getattr(self, "corpusaction_set", None)
...
class ColumnType(Node):
    ...
    validation_config: Optional[GenericScalar] = strawberry.field(name="validationConfig", default=None)
    is_manual_entry: bool = strawberry.field(name="isManualEntry", description='True for manual metadata, False for extraction', default=None)
    default_value: Optional[GenericScalar] = strawberry.field(name="defaultValue", default=None)
    ...
    display_order: int = strawberry.field(name="displayOrder", description='Order in which to display manual entry fields', default=None)
    @strawberry.field(name="extractedDatacells")
    def extracted_datacells(self, info: strawberry.Info, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> "DatacellTypeConnection":
        kwargs = strip_unset({"offset": offset, "before": before, "after": after, "first": first, "last": last})
        resolved = getattr(self, "extracted_datacells", None)
...
class DatacellType(Node):
    ...
    created: datetime.datetime = strawberry.field(name="created", default=None)
    modified: datetime.datetime = strawberry.field(name="modified", default=None)
    extract: Optional["ExtractType"] = strawberry.field(name="extract", default=None)
    ...
    started: Optional[datetime.datetime] = strawberry.field(name="started", default=None)
    completed: Optional[datetime.datetime] = strawberry.field(name="completed", default=None)
    failed: Optional[datetime.datetime] = strawberry.field(name="failed", default=None)
    ...
    approved_by: Optional[Annotated["UserType", strawberry.lazy("config.graphql.user_types")]] = strawberry.field(name="approvedBy", default=None)
    rejected_by: Optional[Annotated["UserType", strawberry.lazy("config.graphql.user_types")]] = strawberry.field(name="rejectedBy", default=None)
    corrected_data: Optional[GenericScalar] = strawberry.field(name="correctedData", default=None)
    ...
    def full_source_list(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql.annotation_types")]]]]:
        kwargs = strip_unset({})
...
class AnalysisType(Node):
    ...
    analyzed_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql.corpus_types")]] = strawberry.field(name="analyzedCorpus", default=None)
    corpus_action: Optional[Annotated["CorpusActionType", strawberry.lazy("config.graphql.agent_types")]] = strawberry.field(name="corpusAction", default=None)
    ...
    analysis_started: Optional[datetime.datetime] = strawberry.field(name="analysisStarted", default=None)
    analysis_completed: Optional[datetime.datetime] = strawberry.field(name="analysisCompleted", default=None)
    ...
    def full_annotation_list(self, info: strawberry.Info, document_id: Annotated[Optional[strawberry.ID], strawberry.argument(name="documentId")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql.annotation_types")]]]]:
