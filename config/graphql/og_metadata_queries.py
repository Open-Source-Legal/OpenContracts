...
def q_og_corpus_metadata(info: strawberry.Info, user_slug: Annotated[str, strawberry.argument(name="userSlug")] = strawberry.UNSET, corpus_slug: Annotated[str, strawberry.argument(name="corpusSlug")] = strawberry.UNSET) -> Optional[Annotated["OGCorpusMetadataType", strawberry.lazy("config.graphql.og_metadata_types")]]:
...
def q_og_document_metadata(info: strawberry.Info, user_slug: Annotated[str, strawberry.argument(name="userSlug")] = strawberry.UNSET, document_slug: Annotated[str, strawberry.argument(name="documentSlug")] = strawberry.UNSET) -> Optional[Annotated["OGDocumentMetadataType", strawberry.lazy("config.graphql.og_metadata_types")]]:
...
def q_og_document_in_corpus_metadata(info: strawberry.Info, user_slug: Annotated[str, strawberry.argument(name="userSlug")] = strawberry.UNSET, corpus_slug: Annotated[str, strawberry.argument(name="corpusSlug")] = strawberry.UNSET, document_slug: Annotated[str, strawberry.argument(name="documentSlug")] = strawberry.UNSET) -> Optional[Annotated["OGDocumentMetadataType", strawberry.lazy("config.graphql.og_metadata_types")]]:
...
def q_og_thread_metadata(info: strawberry.Info, user_slug: Annotated[str, strawberry.argument(name="userSlug")] = strawberry.UNSET, corpus_slug: Annotated[str, strawberry.argument(name="corpusSlug")] = strawberry.UNSET, thread_id: Annotated[str, strawberry.argument(name="threadId")] = strawberry.UNSET) -> Optional[Annotated["OGThreadMetadataType", strawberry.lazy("config.graphql.og_metadata_types")]]:
...
def q_og_extract_metadata(info: strawberry.Info, extract_id: Annotated[str, strawberry.argument(name="extractId")] = strawberry.UNSET) -> Optional[Annotated["OGExtractMetadataType", strawberry.lazy("config.graphql.og_metadata_types")]]:
