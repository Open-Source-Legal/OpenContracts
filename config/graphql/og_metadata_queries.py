...
from config.graphql.user_types import _redacted_handle
    ...
    def resolve_og_corpus_metadata(
        ...
        try:
            ...
            return OGCorpusMetadataType(
                ...
                creator_name=corpus.creator.slug or _redacted_handle(corpus.creator),
                is_public=True,
            )
    ...
    def resolve_og_document_metadata(
        ...
        try:
            ...
            return OGDocumentMetadataType(
                ...
                or _redacted_handle(document.creator),
                is_public=True,
            )
    ...
    def resolve_og_thread_metadata(
        ...
        try:
            ...
            return OGThreadMetadataType(
                ...
                creator_name=(
                    (thread.creator.slug or _redacted_handle(thread.creator))
                    if thread.creator
                    else "Anonymous"
                ),
                is_public=True,
    ...
    def resolve_og_extract_metadata(
        ...
        try:
            ...
            return OGExtractMetadataType(
                ...
                creator_name=(
                    (extract.creator.slug or _redacted_handle(extract.creator))
                    if extract.creator
                    else "System"
                ),
                is_public=True,
