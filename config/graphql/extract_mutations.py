...
def _mutate_UpdateExtractMutation(
    payload_cls, root, info, id, title=None, corpus_id=None, fieldset_id=None, error=None
):
...
def _mutate_DeleteMetadataValue(payload_cls, root, info, document_id, corpus_id, column_id):
