...
class StartCorpusFork:
    ...
    new_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="newCorpus")
...
class CreateCorpusAction:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    obj: Optional[Annotated["CorpusActionType", strawberry.lazy("config.graphql_new.agent_types")]] = strawberry.field(name="obj")
...
class RunCorpusAction:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    obj: Optional[Annotated["CorpusActionExecutionType", strawberry.lazy("config.graphql_new.agent_types")]] = strawberry.field(name="obj")
...
class StartCorpusActionBatchRun:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    queued_count: Optional[int] = strawberry.field(name="queuedCount", description='Number of new CorpusActionExecution rows created.')
    skipped_already_run_count: Optional[int] = strawberry.field(name="skippedAlreadyRunCount", description='Active documents skipped because they already have a queued, running, or completed execution for this action.')
    total_active_documents: Optional[int] = strawberry.field(name="totalActiveDocuments", description='Total active documents in the corpus at evaluation time.')
    @strawberry.field(name="executions", description='The freshly created execution rows (status=QUEUED).')
    def executions(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["CorpusActionExecutionType", strawberry.lazy("config.graphql_new.agent_types")]]]]:
...
class SetupCorpusIntelligence:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    summary: Optional[Annotated["CorpusIntelligenceSetupSummaryType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="summary")
...
class CreateArtifact:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    artifact: Optional[Annotated["ArtifactType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="artifact")
