...
def q_chat_message(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["MessageType", strawberry.lazy("config.graphql_new.conversation_types")]]:
...
def q_moderation_action(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id")] = strawberry.UNSET) -> Optional[Annotated["ModerationActionType", strawberry.lazy("config.graphql_new.conversation_types")]]:
...
def q_moderation_metrics(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET, time_range_hours: Annotated[Optional[int], strawberry.argument(name="timeRangeHours")] = 24) -> Optional[Annotated["ModerationMetricsType", strawberry.lazy("config.graphql_new.conversation_types")]]:
