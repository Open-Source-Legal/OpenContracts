...
def q_corpus_filter_counts(info: strawberry.Info, text_search: Annotated[Optional[str], strawberry.argument(name="textSearch", description='Optional text search to apply alongside the tab counts so badges match the result set the user actually sees when searching.')] = strawberry.UNSET) -> Optional[Annotated["CorpusFilterCountsType", strawberry.lazy("config.graphql_new.corpus_types")]]:
...
def q_corpus_folders(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["CorpusFolderType", strawberry.lazy("config.graphql_new.corpus_types")]]]]:
...
def q_corpus_folder(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id")] = strawberry.UNSET) -> Optional[Annotated["CorpusFolderType", strawberry.lazy("config.graphql_new.corpus_types")]]:
...
def q_deleted_documents_in_corpus(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["DocumentPathType", strawberry.lazy("config.graphql_new.document_types")]]]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_intelligence_setup_status(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["CorpusIntelligenceSetupStatusType", strawberry.lazy("config.graphql_new.corpus_types")]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_stats(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["CorpusStatsType", strawberry.lazy("config.graphql_new.corpus_types")]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_intelligence_aggregates(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["CorpusIntelligenceAggregatesType", strawberry.lazy("config.graphql_new.corpus_types")]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_data_story(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["CorpusDataStoryType", strawberry.lazy("config.graphql_new.corpus_types")]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_artifact_by_slug(info: strawberry.Info, slug: Annotated[str, strawberry.argument(name="slug")] = strawberry.UNSET) -> Optional[Annotated["ArtifactType", strawberry.lazy("config.graphql_new.corpus_types")]]:
...
def q_corpus_artifacts(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Annotated["ArtifactType", strawberry.lazy("config.graphql_new.corpus_types")]]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_artifact_templates(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Annotated["ArtifactTemplateType", strawberry.lazy("config.graphql_new.corpus_types")]]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
...
def q_corpus_metadata_columns(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["ColumnType", strawberry.lazy("config.graphql_new.extract_types")]]]]:
    kwargs = strip_unset({"corpus_id": corpus_id})
