...
class ConversationType(Node):
    ...
    created_at: datetime.datetime = strawberry.field(name="createdAt", description='Timestamp when the conversation was created')
    updated_at: datetime.datetime = strawberry.field(name="updatedAt", description='Timestamp when the conversation was last updated')
    ...
    deleted_at: Optional[datetime.datetime] = strawberry.field(name="deletedAt", description='Timestamp when the conversation was soft-deleted')
    is_locked: bool = strawberry.field(name="isLocked", description='Whether the thread is locked (prevents new messages)')
    locked_at: Optional[datetime.datetime] = strawberry.field(name="lockedAt", description='Timestamp when the thread was locked')
    locked_by: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="lockedBy", description='Moderator who locked the thread')
    is_pinned: bool = strawberry.field(name="isPinned", description='Whether the thread is pinned (appears at top of list)')
    pinned_at: Optional[datetime.datetime] = strawberry.field(name="pinnedAt", description='Timestamp when the thread was pinned')
    pinned_by: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="pinnedBy", description='Moderator who pinned the thread')
    upvote_count: int = strawberry.field(name="upvoteCount", description='Cached count of upvotes for this conversation/thread')
    downvote_count: int = strawberry.field(name="downvoteCount", description='Cached count of downvotes for this conversation/thread')
    chat_with_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="chatWithCorpus", description='The corpus to which this conversation belongs')
    chat_with_document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="chatWithDocument", description='The document to which this conversation belongs')
    ...
    compacted_before_message_id: Optional[BigInt] = strawberry.field(name="compactedBeforeMessageId", description='ID of the last message that was folded into compaction_summary.  Messages with id <= this value are excluded from LLM context (but kept in the DB).  Stored as a plain integer (not a ForeignKey) so the id__gt filter remains valid even if the cutoff message is deleted.')
    memory_curated: bool = strawberry.field(name="memoryCurated", description='Whether this conversation has been curated for corpus memory.')
...
class MessageType(Node):
    ...
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    conversation: "ConversationType" = strawberry.field(name="conversation", description='The conversation to which this chat message belongs')
    ...
    def agent_configuration(self, info: strawberry.Info) -> Optional[Annotated["AgentConfigurationType", strawberry.lazy("config.graphql_new.agent_types")]]:
        kwargs = strip_unset({})
        return _resolve_MessageType_agent_configuration(self, info, **kwargs)
    parent_message: Optional["MessageType"] = strawberry.field(name="parentMessage", description='Parent message for threaded replies')
    ...
    created_at: datetime.datetime = strawberry.field(name="createdAt", description='Timestamp when the chat message was created')
    deleted_at: Optional[datetime.datetime] = strawberry.field(name="deletedAt", description='Timestamp when the message was soft-deleted')
    source_document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="sourceDocument", description='A document that this chat message is based on')
    ...
    upvote_count: int = strawberry.field(name="upvoteCount", description='Cached count of upvotes for this message')
    downvote_count: int = strawberry.field(name="downvoteCount", description='Cached count of downvotes for this message')
...
class ModerationActionType(Node):
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    conversation: Optional["ConversationType"] = strawberry.field(name="conversation", description='The conversation that was moderated')
    ...
    moderator: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="moderator", description='Moderator who took this action')
...
class MentionedResourceType:
    ...
    corpus: Optional["MentionedResourceType"] = strawberry.field(name="corpus", description='Parent corpus context (for documents within a corpus)')
    ...
    document: Optional["MentionedResourceType"] = strawberry.field(name="document", description='Parent document (for annotations)')
...
class ModerationMetricsType:
    ...
    automated_actions: Optional[int] = strawberry.field(name="automatedActions")
    manual_actions: Optional[int] = strawberry.field(name="manualActions")
    actions_by_type: Optional[GenericScalar] = strawberry.field(name="actionsByType")
    hourly_action_rate: Optional[float] = strawberry.field(name="hourlyActionRate")
    is_above_threshold: Optional[bool] = strawberry.field(name="isAboveThreshold")
    ...
    time_range_hours: Optional[int] = strawberry.field(name="timeRangeHours")
    start_time: Optional[datetime.datetime] = strawberry.field(name="startTime")
    end_time: Optional[datetime.datetime] = strawberry.field(name="endTime")
