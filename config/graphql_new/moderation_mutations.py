...
class DeleteThreadMutation:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    conversation: Optional[Annotated["ConversationType", strawberry.lazy("config.graphql_new.conversation_types")]] = strawberry.field(name="conversation")
...
class RollbackModerationActionMutation:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    rollback_action: Optional[Annotated["ModerationActionType", strawberry.lazy("config.graphql_new.conversation_types")]] = strawberry.field(name="rollbackAction")
