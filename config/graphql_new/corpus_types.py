...
class CorpusType(Node):
    parent: Optional["CorpusType"] = strawberry.field(name="parent")
    ...
    def readme_caml_document(self, info: strawberry.Info) -> Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]]:
        kwargs = strip_unset({})
    ...
    auto_branding_enabled: bool = strawberry.field(name="autoBrandingEnabled", description='When True, auto-generate a logo and Readme.CAML article on creation if no icon was uploaded. Set False to opt this corpus out of auto-branding.')
    ...
    def label_set(self, info: strawberry.Info) -> Optional[Annotated["LabelSetType", strawberry.lazy("config.graphql_new.annotation_types")]]:
        kwargs = strip_unset({})
    ...
    memory_enabled: bool = strawberry.field(name="memoryEnabled", description='Enable agent memory system for this corpus. When enabled, agents accumulate reusable insights from conversations into a memory document.')
    memory_document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="memoryDocument", description='The Document storing accumulated agent memory for this corpus.')
    ...
    allow_comments: bool = strawberry.field(name="allowComments")
    ...
    error: bool = strawberry.field(name="error")
    is_personal: bool = strawberry.field(name="isPersonal", description="True if this is the user's personal 'My Documents' corpus")
    upvote_count: int = strawberry.field(name="upvoteCount", description='Cached count of upvotes for this corpus')
    downvote_count: int = strawberry.field(name="downvoteCount", description='Cached count of downvotes for this corpus')
    score: int = strawberry.field(name="score", description='upvote_count - downvote_count, denormalized for sorting')
    ...
    def assignment_set(self, info: strawberry.Info, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> Annotated["AssignmentTypeConnection", strawberry.lazy("config.graphql_new.user_types")]:
    ...
    metadata_schema: Optional[Annotated["FieldsetType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="metadataSchema")
    ...
    def documents(self, info: strawberry.Info, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> Optional[Annotated["DocumentTypeConnection", strawberry.lazy("config.graphql_new.document_types")]]:
...
class CorpusCategoryType(Node):
    ...
    sort_order: int = strawberry.field(name="sortOrder", description='Order in which categories appear in UI')
...
class CorpusFolderType(Node):
    ...
    def name(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "name", None))
    corpus: "CorpusType" = strawberry.field(name="corpus", description='Parent corpus this folder belongs to')
    @strawberry.field(name="description")
    def description(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "description", None))
    ...
    def icon(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "icon", None))
    tags: JSONString = strawberry.field(name="tags", description='List of tags for categorization')
    is_public: bool = strawberry.field(name="isPublic")
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    creator: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="creator")
...
class CorpusEngagementMetricsType:
    total_threads: Optional[int] = strawberry.field(name="totalThreads", description='Total number of discussion threads in this corpus')
    active_threads: Optional[int] = strawberry.field(name="activeThreads", description='Number of active (not locked/deleted) threads')
    total_messages: Optional[int] = strawberry.field(name="totalMessages", description='Total number of messages across all threads')
    messages_last_7_days: Optional[int] = strawberry.field(name="messagesLast7Days", description='Number of messages posted in the last 7 days')
    messages_last_30_days: Optional[int] = strawberry.field(name="messagesLast30Days", description='Number of messages posted in the last 30 days')
    unique_contributors: Optional[int] = strawberry.field(name="uniqueContributors", description='Total number of unique users who have posted messages')
    active_contributors_30_days: Optional[int] = strawberry.field(name="activeContributors30Days", description='Number of users who posted in the last 30 days')
    total_upvotes: Optional[int] = strawberry.field(name="totalUpvotes", description='Total upvotes across all messages in this corpus')
    avg_messages_per_thread: Optional[float] = strawberry.field(name="avgMessagesPerThread", description='Average number of messages per thread')
    last_updated: Optional[datetime.datetime] = strawberry.field(name="lastUpdated", description='Timestamp when metrics were last calculated')
...
class CorpusDescriptionRevisionType:
    ...
    def author(self, info: strawberry.Info) -> Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]]:
        kwargs = strip_unset({})
...
class CorpusFilterCountsType:
    all: int = strawberry.field(name="all")
    mine: int = strawberry.field(name="mine")
    shared: int = strawberry.field(name="shared")
    public: int = strawberry.field(name="public")
...
class CorpusIntelligenceSetupStatusType:
    reference_available: bool = strawberry.field(name="referenceAvailable", description='The reference-enrichment analyzer is registered on this deployment.')
    reference_action_installed: bool = strawberry.field(name="referenceActionInstalled")
    ...
    is_fully_set_up: bool = strawberry.field(name="isFullySetUp", description='Every deployment-installable bundle piece is installed (unavailable pieces — unregistered analyzer, inactive template — are excluded).')
    can_setup: bool = strawberry.field(name="canSetup", description="The requesting user holds the permission setupCorpusIntelligence requires (CRUD) — drives the setup CTA's visibility.")
...
class CorpusStatsType:
    total_docs: Optional[int] = strawberry.field(name="totalDocs")
    total_annotations: Optional[int] = strawberry.field(name="totalAnnotations")
    total_comments: Optional[int] = strawberry.field(name="totalComments")
    total_analyses: Optional[int] = strawberry.field(name="totalAnalyses")
    total_extracts: Optional[int] = strawberry.field(name="totalExtracts")
    total_threads: Optional[int] = strawberry.field(name="totalThreads")
    total_chats: Optional[int] = strawberry.field(name="totalChats")
    total_relationships: Optional[int] = strawberry.field(name="totalRelationships")
...
class CorpusDocumentGraphType:
    ...
    total_node_count: int = strawberry.field(name="totalNodeCount", description='Distinct documents participating in any visible relationship.')
    total_edge_count: int = strawberry.field(name="totalEdgeCount", description='Total visible relationships in the corpus.')
    truncated: bool = strawberry.field(name="truncated", description='True when nodes/edges were dropped to honor the limit.')
...
class CorpusDocumentGraphNodeType:
    ...
    degree: int = strawberry.field(name="degree", description='Number of visible relationships touching this document.')
...
class CorpusIntelligenceAggregatesType:
    ...
    documents_with_summary: int = strawberry.field(name="documentsWithSummary", description='Visible documents that have a markdown summary.')
    total_documents: int = strawberry.field(name="totalDocuments", description='Visible documents with an active path in the corpus.')
...
class LabelDistributionEntryType:
    ...
    def color(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "color", None))
    count: int = strawberry.field(name="count")
...
class CorpusDataStoryProfileType:
    ...
    value: Optional[float] = strawberry.field(name="value", description='Primary dollar value, positive or null.')
...
class ArtifactType:
    ...
    config: Optional[GenericScalar] = strawberry.field(name="config")
...
class ArtifactTemplateType:
    ...
    def description(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "description", None))
    eligible: bool = strawberry.field(name="eligible")
...
class CorpusIntelligenceSetupSummaryType:
    reference_available: bool = strawberry.field(name="referenceAvailable", description='The reference-enrichment analyzer is registered on this deployment.')
    reference_action_installed_now: bool = strawberry.field(name="referenceActionInstalledNow")
    reference_action_already_installed: bool = strawberry.field(name="referenceActionAlreadyInstalled")
    reference_analysis_started: bool = strawberry.field(name="referenceAnalysisStarted", description='An immediate reference-web weave was started.')
    total_active_documents: int = strawberry.field(name="totalActiveDocuments")
...
class IntelligenceTemplateOutcomeType:
    ...
    installed_now: bool = strawberry.field(name="installedNow", description='Template was cloned into the corpus by this call.')
    already_installed: bool = strawberry.field(name="alreadyInstalled", description="The corpus already had this template's action.")
    queued_count: int = strawberry.field(name="queuedCount", description='Documents queued for an agent run by this call.')
    skipped_already_run_count: int = strawberry.field(name="skippedAlreadyRunCount", description='Documents skipped because they already ran.')
    ...
    remaining_count: int = strawberry.field(name="remainingCount", description='Documents deferred past the per-call batch cap — re-run setup (or wait for the add_document trigger) to process them.')
