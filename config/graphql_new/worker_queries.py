...
def q_worker_accounts(info: strawberry.Info, name_contains: Annotated[Optional[str], strawberry.argument(name="nameContains")] = strawberry.UNSET, is_active: Annotated[Optional[bool], strawberry.argument(name="isActive")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["WorkerAccountQueryType", strawberry.lazy("config.graphql_new.worker_types")]]]]:
...
def q_corpus_access_tokens(info: strawberry.Info, corpus_id: Annotated[int, strawberry.argument(name="corpusId")] = strawberry.UNSET, is_active: Annotated[Optional[bool], strawberry.argument(name="isActive")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["CorpusAccessTokenQueryType", strawberry.lazy("config.graphql_new.worker_types")]]]]:
