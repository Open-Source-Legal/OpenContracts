...
class AddAnnotation:
    ...
    annotation: Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="annotation")
...
class AddCountryAnnotation:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    annotation: Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="annotation")
    geocoded: Optional[bool] = strawberry.field(name="geocoded", description='True if the offline geocoder resolved the span; False when the annotation was created but no map pin was generated.')
...
class ApproveAnnotation:
    ok: Optional[bool] = strawberry.field(name="ok")
    user_feedback: Optional[Annotated["UserFeedbackType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="userFeedback")
    @strawberry.field(name="message")
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
...
class AddRelationship:
    ok: Optional[bool] = strawberry.field(name="ok")
    relationship: Optional[Annotated["RelationshipType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="relationship")
    @strawberry.field(name="message")
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
...
class UpdateNote:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    obj: Optional[Annotated["NoteType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="obj")
...
def m_update_relationships(info: strawberry.Info, relationships: Annotated[Optional[list[Optional[Annotated["RelationInputType", strawberry.lazy("config.graphql_new.annotation_types")]]]], strawberry.argument(name="relationships")] = strawberry.UNSET) -> Optional["UpdateRelations"]:
