...
class VersionHistoryType:
    ...
    current_version: "DocumentVersionType" = strawberry.field(name="currentVersion", description='The current active version')
    version_tree: Optional[GenericScalar] = strawberry.field(name="versionTree", description='Tree structure of version relationships')
...
class DocumentVersionType:
    ...
    version_number: int = strawberry.field(name="versionNumber", description='Sequential version number')
    ...
    created_at: datetime.datetime = strawberry.field(name="createdAt", description='When version was created')
    created_by: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="createdBy", description='User who created this version')
    size_bytes: Optional[int] = strawberry.field(name="sizeBytes", description='File size in bytes')
    ...
    parent_version: Optional["DocumentVersionType"] = strawberry.field(name="parentVersion", description='Previous version in content tree')
...
class PathHistoryType:
    ...
    move_count: int = strawberry.field(name="moveCount", description='Number of move/rename operations')
...
class PathEventType:
    ...
    folder: Optional[Annotated["CorpusFolderType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="folder", description='Folder at time of event (null if at root)')
    timestamp: datetime.datetime = strawberry.field(name="timestamp", description='When this event occurred')
    user: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="user", description='User who performed the action')
    version_number: int = strawberry.field(name="versionNumber", description='Content version at time of event')
...
class CorpusVersionInfoType:
    version_number: int = strawberry.field(name="versionNumber", description='Version number in this corpus')
    ...
    created: datetime.datetime = strawberry.field(name="created", description='When this version was created')
    is_current: bool = strawberry.field(name="isCurrent", description='Whether this is the current (latest) version')
...
class PageAwareAnnotationType:
    pdf_page_info: Optional["PdfPageInfoType"] = strawberry.field(name="pdfPageInfo")
    @strawberry.field(name="pageAnnotations")
    def page_annotations(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
...
class PdfPageInfoType:
    ...
    current_page: Optional[int] = strawberry.field(name="currentPage")
    has_next_page: Optional[bool] = strawberry.field(name="hasNextPage")
    has_previous_page: Optional[bool] = strawberry.field(name="hasPreviousPage")
