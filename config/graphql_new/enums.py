...
@strawberry.enum(name="AgentsAgentActionResultStatusChoices", description='An enumeration.')
...
@strawberry.enum(name="AgentsAgentConfigurationScopeChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsAnnotationLabelLabelTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsAuthorityFrontierAuthorityTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsAuthorityFrontierDiscoveryStateChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsAuthorityKeyEquivalenceSourceChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsCorpusReferenceAuthorityTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsCorpusReferenceDetectionTierChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsCorpusReferenceReferenceTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="AnnotationsCorpusReferenceResolutionStatusChoices", description='An enumeration.')
...
@strawberry.enum(name="ConversationTypeEnum", description='Enum for conversation types.')
class ConversationTypeEnum(Enum):
    CHAT = 'chat'
    THREAD = 'thread'


@strawberry.enum(name="ConversationsChatMessageMsgTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="ConversationsChatMessageStateChoices", description='An enumeration.')
...
@strawberry.enum(name="ConversationsModerationActionActionTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="CorpusesCorpusActionExecutionActionTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="CorpusesCorpusActionExecutionStatusChoices", description='An enumeration.')
...
@strawberry.enum(name="CorpusesCorpusActionExecutionTriggerChoices", description='An enumeration.')
...
@strawberry.enum(name="CorpusesCorpusActionTemplateTriggerChoices", description='An enumeration.')
...
@strawberry.enum(name="CorpusesCorpusActionTriggerChoices", description='An enumeration.')
...
@strawberry.enum(name="DocumentProcessingStatusEnum", description='Enum for document processing status in the parsing pipeline.')
...
@strawberry.enum(name="DocumentsDocumentRelationshipRelationshipTypeChoices", description='An enumeration.')
class DocumentsDocumentRelationshipRelationshipTypeChoices(Enum):
    NOTES = 'NOTES'
    RELATIONSHIP = 'RELATIONSHIP'


@strawberry.enum(name="DocumentsIngestionSourceSourceTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="LeaderboardMetricEnum", description='Enum for different leaderboard metrics.\n\nIssue: #613 - Create leaderboard and community stats dashboard\nEpic: #572 - Social Features Epic')
...
@strawberry.enum(name="LeaderboardScopeEnum", description='Enum for leaderboard scope (time period or corpus).\n\nIssue: #613 - Create leaderboard and community stats dashboard')
...
@strawberry.enum(name="NotificationsNotificationNotificationTypeChoices", description='An enumeration.')
...
@strawberry.enum(name="PathActionEnum", description='Enum for document path lifecycle actions.')
...
@strawberry.enum(name="ResearchResearchReportStatusChoices", description='An enumeration.')
