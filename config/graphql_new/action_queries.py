...
def q_corpus_action_templates(info: strawberry.Info, is_active: Annotated[Optional[bool], strawberry.argument(name="isActive")] = strawberry.UNSET, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> Optional[Annotated["CorpusActionTemplateTypeConnection", strawberry.lazy("config.graphql_new.agent_types")]]:
...
def q_corpus_action_trail_stats(info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET, since: Annotated[Optional[datetime.datetime], strawberry.argument(name="since")] = strawberry.UNSET) -> Optional[Annotated["CorpusActionTrailStatsType", strawberry.lazy("config.graphql_new.agent_types")]]:
