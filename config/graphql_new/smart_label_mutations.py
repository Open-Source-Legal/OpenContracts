...
class SmartLabelSearchOrCreateMutation:
    ...
    def labels(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["AnnotationLabelType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
        return resolve_django_list(self, info, getattr(self, "labels"), "AnnotationLabelType")
    labelset: Optional[Annotated["LabelSetType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="labelset", description='The labelset (existing or newly created)')
    labelset_created: Optional[bool] = strawberry.field(name="labelsetCreated", description='Whether a new labelset was created')
    label_created: Optional[bool] = strawberry.field(name="labelCreated", description='Whether a new label was created')
...
class SmartLabelListMutation:
    ...
    def labels(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["AnnotationLabelType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
        return resolve_django_list(self, info, getattr(self, "labels"), "AnnotationLabelType")
    has_labelset: Optional[bool] = strawberry.field(name="hasLabelset")
    can_create_labels: Optional[bool] = strawberry.field(name="canCreateLabels")
