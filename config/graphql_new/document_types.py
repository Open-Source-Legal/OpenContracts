...
class DocumentType(Node):
    parent: Optional["DocumentType"] = strawberry.field(name="parent")
    ...
    custom_meta: Optional[JSONString] = strawberry.field(name="customMeta")
    ...
    version_tree_id: uuid.UUID = strawberry.field(name="versionTreeId", description='Groups all content versions of same logical document. Implements Rule C1.')
    is_current: bool = strawberry.field(name="isCurrent", description='True for newest content in this version tree. Implements Rule C3.')
    source_document: Optional["DocumentType"] = strawberry.field(name="sourceDocument", description='Original document this was copied from (cross-corpus provenance). Implements Rule I2.')
    ...
    memory_for_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="memoryForCorpus")
    ...
    def doc_type_labels(self, info: strawberry.Info) -> Optional[list[Annotated["AnnotationLabelType", strawberry.lazy("config.graphql_new.annotation_types")]]]:
        kwargs = strip_unset({})
        return _resolve_DocumentType_doc_type_labels(self, info, **kwargs)
    @strawberry.field(name="allStructuralAnnotations")
    def all_structural_annotations(self, info: strawberry.Info, annotation_ids: Annotated[Optional[list[strawberry.ID]], strawberry.argument(name="annotationIds")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["AnnotationType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
    ...
    def all_structural_relationships(self, info: strawberry.Info, relationship_ids: Annotated[Optional[list[strawberry.ID]], strawberry.argument(name="relationshipIds")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["RelationshipType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
    ...
    def all_notes(self, info: strawberry.Info, corpus_id: Annotated[Optional[strawberry.ID], strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["NoteType", strawberry.lazy("config.graphql_new.annotation_types")]]]]:
        kwargs = strip_unset({"corpus_id": corpus_id})
    ...
    def version_history(self, info: strawberry.Info) -> Optional[Annotated["VersionHistoryType", strawberry.lazy("config.graphql_new.base_types")]]:
        kwargs = strip_unset({})
    ...
    def path_history(self, info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["PathHistoryType", strawberry.lazy("config.graphql_new.base_types")]]:
        kwargs = strip_unset({"corpus_id": corpus_id})
    ...
    def corpus_versions(self, info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[list[Annotated["CorpusVersionInfoType", strawberry.lazy("config.graphql_new.base_types")]]]:
        kwargs = strip_unset({"corpus_id": corpus_id})
    ...
    def folder_in_corpus(self, info: strawberry.Info, corpus_id: Annotated[strawberry.ID, strawberry.argument(name="corpusId")] = strawberry.UNSET) -> Optional[Annotated["CorpusFolderType", strawberry.lazy("config.graphql_new.corpus_types")]]:
        kwargs = strip_unset({"corpus_id": corpus_id})
...
class DocumentAnalysisRowType(Node):
    ...
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    document: "DocumentType" = strawberry.field(name="document")
    ...
    extract: Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="extract")
    @strawberry.field(name="myPermissions")
    def my_permissions(self, info: strawberry.Info) -> Optional[GenericScalar]:
        return core_permissions.resolve_my_permissions(self, info)
    @strawberry.field(name="isPublished")
...
class DocumentRelationshipType(Node):
    ...
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    source_document: "DocumentType" = strawberry.field(name="sourceDocument")
    target_document: "DocumentType" = strawberry.field(name="targetDocument")
    ...
    annotation_label: Optional[Annotated["AnnotationLabelType", strawberry.lazy("config.graphql_new.annotation_types")]] = strawberry.field(name="annotationLabel")
...
class DocumentPathType(Node):
    parent: Optional["DocumentPathType"] = strawberry.field(name="parent")
    user_lock: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="userLock")
    backend_lock: bool = strawberry.field(name="backendLock")
    is_public: bool = strawberry.field(name="isPublic")
    creator: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="creator")
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    document: "DocumentType" = strawberry.field(name="document", description='Specific content version this path points to')
    corpus: Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")] = strawberry.field(name="corpus", description='Corpus owning this path')
    folder: Optional[Annotated["CorpusFolderType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="folder", description='Current folder (null if folder deleted or at root)')
    ...
    version_number: int = strawberry.field(name="versionNumber", description='Content version number (Rule P5: increments only on content changes)')
    is_deleted: bool = strawberry.field(name="isDeleted", description='Soft delete flag')
    is_current: bool = strawberry.field(name="isCurrent", description='True for current filesystem state (Rule P3)')
    ingestion_source: Optional["IngestionSourceType"] = strawberry.field(name="ingestionSource", description='Source integration that produced this version (null = manual upload)')
    ...
    ingestion_metadata: Optional[GenericScalar] = strawberry.field(name="ingestionMetadata", description='Arbitrary source-specific metadata (URL, crawl job ID, etc.)')
    @strawberry.field(name="children")
    def children(self, info: strawberry.Info, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> "DocumentPathTypeConnection":
        kwargs = strip_unset({"offset": offset, "before": before, "after": after, "first": first, "last": last})
        resolved = getattr(self, "children", None)
...
class IngestionSourceType(Node):
    ...
    config: Optional[GenericScalar] = strawberry.field(name="config", description='Source configuration (connection details, etc.). WARNING: This field is returned to the owning user verbatim. Store secret-manager key paths or references here, never raw credentials (API keys, tokens, passwords).')
    active: bool = strawberry.field(name="active", description='Whether this source is actively ingesting documents')
    @strawberry.field(name="myPermissions")
    def my_permissions(self, info: strawberry.Info) -> Optional[GenericScalar]:
        return core_permissions.resolve_my_permissions(self, info)
    @strawberry.field(name="isPublished")
...
class DocumentCorpusActionsType:
    ...
    def corpus_actions(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["CorpusActionType", strawberry.lazy("config.graphql_new.agent_types")]]]]:
        return resolve_django_list(self, info, getattr(self, "corpus_actions"), "CorpusActionType")
    @strawberry.field(name="extracts")
    def extracts(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]]]]:
...
class DocumentStatsType:
    total_docs: int = strawberry.field(name="totalDocs")
    total_pages: int = strawberry.field(name="totalPages")
    processed_count: int = strawberry.field(name="processedCount")
    processing_count: int = strawberry.field(name="processingCount")
