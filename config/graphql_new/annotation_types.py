...
class AnnotationType(Node):
    ...
    page: int = strawberry.field(name="page")
    ...
    json: Optional[GenericScalar] = strawberry.field(name="json")
    parent: Optional["AnnotationType"] = strawberry.field(name="parent")
    ...
    annotation_label: Optional["AnnotationLabelType"] = strawberry.field(name="annotationLabel")
    ...
    analysis: Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="analysis")
    created_by_analysis: Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="createdByAnalysis", description='If set, this annotation is private to the analysis that created it')
    created_by_extract: Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="createdByExtract", description='If set, this annotation is private to the extract that created it')
    corpus_action: Optional[Annotated["CorpusActionType", strawberry.lazy("config.graphql_new.agent_types")]] = strawberry.field(name="corpusAction", description='If set, this annotation was created by a corpus action agent')
    structural: bool = strawberry.field(name="structural")
    ...
    is_grounding_source: bool = strawberry.field(name="isGroundingSource")
    ...
    def user_feedback(self, info: strawberry.Info, offset: Annotated[Optional[int], strawberry.argument(name="offset")] = strawberry.UNSET, before: Annotated[Optional[str], strawberry.argument(name="before")] = strawberry.UNSET, after: Annotated[Optional[str], strawberry.argument(name="after")] = strawberry.UNSET, first: Annotated[Optional[int], strawberry.argument(name="first")] = strawberry.UNSET, last: Annotated[Optional[int], strawberry.argument(name="last")] = strawberry.UNSET) -> Annotated["UserFeedbackTypeConnection", strawberry.lazy("config.graphql_new.user_types")]:
        kwargs = strip_unset({"offset": offset, "before": before, "after": after, "first": first, "last": last})
...
class AnnotationLabelType(Node):
    ...
    analyzer: Optional[Annotated["AnalyzerType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="analyzer")
    read_only: bool = strawberry.field(name="readOnly")
...
class RelationshipType(Node):
    user_lock: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="userLock")
    backend_lock: bool = strawberry.field(name="backendLock")
    relationship_label: Optional["AnnotationLabelType"] = strawberry.field(name="relationshipLabel")
    corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="corpus")
    ...
    analyzer: Optional[Annotated["AnalyzerType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="analyzer")
    analysis: Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="analysis")
    created_by_analysis: Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="createdByAnalysis", description='If set, this relationship is private to the analysis that created it')
    created_by_extract: Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="createdByExtract", description='If set, this relationship is private to the extract that created it')
    structural: bool = strawberry.field(name="structural")
    is_public: bool = strawberry.field(name="isPublic")
    creator: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="creator")
    created: datetime.datetime = strawberry.field(name="created")
...
class CorpusReferenceType(Node):
    ...
    source_annotation: "AnnotationType" = strawberry.field(name="sourceAnnotation")
    target_annotation: Optional["AnnotationType"] = strawberry.field(name="targetAnnotation")
    target_document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="targetDocument")
    target_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="targetCorpus")
    ...
    normalized_data: Optional[GenericScalar] = strawberry.field(name="normalizedData")
    confidence: float = strawberry.field(name="confidence")
    ...
    detection_confidence: float = strawberry.field(name="detectionConfidence")
    ...
    created_by_analysis: Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="createdByAnalysis")
    is_provisional: bool = strawberry.field(name="isProvisional")
...
class NoteType(Node):
    ...
    parent: Optional["NoteType"] = strawberry.field(name="parent")
    corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="corpus")
    document: Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")] = strawberry.field(name="document")
    annotation: Optional["AnnotationType"] = strawberry.field(name="annotation")
    is_public: bool = strawberry.field(name="isPublic")
    creator: Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")] = strawberry.field(name="creator")
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
...
class NoteRevisionType(Node):
    note: "NoteType" = strawberry.field(name="note")
    author: Optional[Annotated["UserType", strawberry.lazy("config.graphql_new.user_types")]] = strawberry.field(name="author")
    version: int = strawberry.field(name="version")
...
class AuthorityNamespaceNode(Node):
    ...
    is_global: bool = strawberry.field(name="isGlobal")
    authority_corpus: Optional[Annotated["CorpusType", strawberry.lazy("config.graphql_new.corpus_types")]] = strawberry.field(name="authorityCorpus")
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
...
class AuthorityFrontierNode(Node):
    ...
    mention_count: int = strawberry.field(name="mentionCount")
    distinct_corpus_count: int = strawberry.field(name="distinctCorpusCount")
    ...
    depth: int = strawberry.field(name="depth")
    @strawberry.field(name="provider")
    def provider(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "provider", None))
    ...
    last_attempt: Optional[datetime.datetime] = strawberry.field(name="lastAttempt")
    created: datetime.datetime = strawberry.field(name="created")
    modified: datetime.datetime = strawberry.field(name="modified")
    candidate_sources: Optional[GenericScalar] = strawberry.field(name="candidateSources", description='Per-corpus demand breakdown: [{corpus_id, mention_count, top_detection_tier}].')
    ingested_document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="ingestedDocument", description='The Document imported for this key once ingested (else null).')
...
class GovernanceGraphType:
    ...
    document_count: int = strawberry.field(name="documentCount", description='Distinct visible document nodes (pre-cap).')
    external_key_count: int = strawberry.field(name="externalKeyCount", description='Distinct external ghost nodes (pre-cap).')
    edge_count: int = strawberry.field(name="edgeCount", description='Distinct edges in the full graph (pre-cap).')
    mention_count: int = strawberry.field(name="mentionCount", description='Total reference mentions across all edges.')
    truncated: bool = strawberry.field(name="truncated", description='True when nodes/edges were dropped to honor the node cap.')
...
class GovernanceGraphNodeType:
    ...
    degree: int = strawberry.field(name="degree", description='Summed mention weight of edges touching the node.')
...
class GovernanceGraphEdgeType:
    ...
    weight: int = strawberry.field(name="weight", description='Mention count.')
...
class WantedAuthorityType:
    ...
    def authority(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "authority", None))
    mention_count: int = strawberry.field(name="mentionCount", description='Total EXTERNAL mentions for this authority.')
    key_count: int = strawberry.field(name="keyCount", description='Distinct section-root keys cited.')
    corpus_count: int = strawberry.field(name="corpusCount", description='Distinct corpora with unresolved citations.')
...
class WantedAuthorityKeyType:
    ...
    def canonical_key(self, info: strawberry.Info) -> str:
        return coerce_str(getattr(self, "canonical_key", None))
    mention_count: int = strawberry.field(name="mentionCount", description='EXTERNAL mentions citing this key.')
    corpus_count: int = strawberry.field(name="corpusCount", description='Distinct corpora citing this key.')
...
class AuthorityFrontierStatsType:
    total_count: int = strawberry.field(name="totalCount", description='Total frontier rows matching the non-state facets.')
...
class AuthorityMappingStatsType:
    total_count: int = strawberry.field(name="totalCount", description='Total equivalence rows matching the search.')
...
class AuthorityDetailType:
    namespace: "AuthorityNamespaceNode" = strawberry.field(name="namespace")
    ...
    reference_total: int = strawberry.field(name="referenceTotal")
...
class AuthoritySourceProviderType:
    ...
    requires_approval: bool = strawberry.field(name="requiresApproval")
    enabled: bool = strawberry.field(name="enabled")
    has_credentials: bool = strawberry.field(name="hasCredentials")
