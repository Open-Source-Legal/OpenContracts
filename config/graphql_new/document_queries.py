...
def q_document(info: strawberry.Info, id: Annotated[Optional[strawberry.ID], strawberry.argument(name="id")] = strawberry.UNSET) -> Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]]:
...
def q_document_relationship(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["DocumentRelationshipType", strawberry.lazy("config.graphql_new.document_types")]]:
...
def q_bulk_doc_relationships(info: strawberry.Info, corpus_id: Annotated[Optional[strawberry.ID], strawberry.argument(name="corpusId")] = strawberry.UNSET, document_id: Annotated[strawberry.ID, strawberry.argument(name="documentId")] = strawberry.UNSET, relationship_type: Annotated[Optional[str], strawberry.argument(name="relationshipType")] = strawberry.UNSET) -> Optional[list[Optional[Annotated["DocumentRelationshipType", strawberry.lazy("config.graphql_new.document_types")]]]]:
...
def q_bulk_document_upload_status(info: strawberry.Info, job_id: Annotated[str, strawberry.argument(name="jobId")] = strawberry.UNSET) -> Optional[Annotated["BulkDocumentUploadStatusType", strawberry.lazy("config.graphql_new.user_types")]]:
...
def q_ingestion_sources(info: strawberry.Info, active_only: Annotated[Optional[bool], strawberry.argument(name="activeOnly", description='If true, only return active sources')] = False) -> Optional[list[Optional[Annotated["IngestionSourceType", strawberry.lazy("config.graphql_new.document_types")]]]]:
...
def q_ingestion_source(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id")] = strawberry.UNSET) -> Optional[Annotated["IngestionSourceType", strawberry.lazy("config.graphql_new.document_types")]]:
    kwargs = strip_unset({"id": id})
