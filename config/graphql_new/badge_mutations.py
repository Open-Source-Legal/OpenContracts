...
class CreateBadgeMutation:
    ...
    badge: Optional[Annotated["BadgeType", strawberry.lazy("config.graphql_new.social_types")]] = strawberry.field(name="badge")
...
class AwardBadgeMutation:
    ...
    def message(self, info: strawberry.Info) -> Optional[str]:
        return coerce_str(getattr(self, "message", None))
    user_badge: Optional[Annotated["UserBadgeType", strawberry.lazy("config.graphql_new.social_types")]] = strawberry.field(name="userBadge")
