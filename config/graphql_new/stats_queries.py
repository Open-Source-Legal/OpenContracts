...
class SystemStatsType:
    user_count: Optional[int] = strawberry.field(name="userCount", description='Active users.')
    document_count: Optional[int] = strawberry.field(name="documentCount", description='Documents with an active path.')
    corpus_count: Optional[int] = strawberry.field(name="corpusCount", description='Corpuses.')
    annotation_count: Optional[int] = strawberry.field(name="annotationCount", description='Non-structural annotations.')
    conversation_count: Optional[int] = strawberry.field(name="conversationCount", description='Non-deleted conversations.')
    message_count: Optional[int] = strawberry.field(name="messageCount", description='Non-deleted chat messages.')
    computed_at: Optional[datetime.datetime] = strawberry.field(name="computedAt", description='When the snapshot was last recomputed; null until first run.')
