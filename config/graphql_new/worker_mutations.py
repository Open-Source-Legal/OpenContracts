...
class CreateWorkerAccount:
    ...
    worker_account: Optional[Annotated["WorkerAccountType", strawberry.lazy("config.graphql_new.worker_types")]] = strawberry.field(name="workerAccount")
...
class CreateCorpusAccessTokenMutation:
    ok: Optional[bool] = strawberry.field(name="ok")
    token: Optional[Annotated["CorpusAccessTokenCreatedType", strawberry.lazy("config.graphql_new.worker_types")]] = strawberry.field(name="token")
