...
class ExtractDiffType:
    extract_a: Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="extractA")
    extract_b: Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="extractB")
    ...
    summary: "ExtractDiffSummaryType" = strawberry.field(name="summary")
...
class ExtractCellDiffType:
    ...
    document: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="document", description='Representative Document (B side preferred). For DOCUMENT_VERSIONS-axis diffs use documentA / documentB to see the actual version on each side.')
    document_a: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="documentA")
    document_b: Optional[Annotated["DocumentType", strawberry.lazy("config.graphql_new.document_types")]] = strawberry.field(name="documentB")
    cell_a: Optional[Annotated["DatacellType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="cellA")
    cell_b: Optional[Annotated["DatacellType", strawberry.lazy("config.graphql_new.extract_types")]] = strawberry.field(name="cellB")
    ...
    column_config_changed: Optional[bool] = strawberry.field(name="columnConfigChanged", description='True when the column on B has a different prompt / instructions / output_type from the column on A (FIELDSET axis).')
...
class ExtractDiffSummaryType:
    unchanged: int = strawberry.field(name="unchanged")
    changed: int = strawberry.field(name="changed")
    only_in_a: int = strawberry.field(name="onlyInA")
    only_in_b: int = strawberry.field(name="onlyInB")
...
class MetadataCompletionStatusType:
    total_fields: Optional[int] = strawberry.field(name="totalFields")
    filled_fields: Optional[int] = strawberry.field(name="filledFields")
    missing_fields: Optional[int] = strawberry.field(name="missingFields")
    percentage: Optional[float] = strawberry.field(name="percentage")
...
class DocumentMetadataResultType:
    ...
    def datacells(self, info: strawberry.Info) -> Optional[list[Optional[Annotated["DatacellType", strawberry.lazy("config.graphql_new.extract_types")]]]]:
...
def q_fieldset(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["FieldsetType", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_column(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["ColumnType", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_extract(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["ExtractType", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_datacell(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["DatacellType", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_gremlin_engine(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["GremlinEngineType_READ", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_analyzer(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["AnalyzerType", strawberry.lazy("config.graphql_new.extract_types")]]:
...
def q_analysis(info: strawberry.Info, id: Annotated[strawberry.ID, strawberry.argument(name="id", description='The ID of the object')] = strawberry.UNSET) -> Optional[Annotated["AnalysisType", strawberry.lazy("config.graphql_new.extract_types")]]:
