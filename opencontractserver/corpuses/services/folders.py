"""Folder and document-in-folder operations for the corpus service layer.

``FolderService`` owns folder CRUD, the folder tree, document placement within
folders, and bulk folder-structure creation for imports. Document moves
between folders are implemented as immutable :class:`DocumentPath` history
nodes via
