...
Queued and resumed research rechecks the active requester, corpus READ, and optional corpus-group scope before starting the loop (`ResearchReportService.require_scope`, `tasks/research_tasks.py::run_deep_research`).
